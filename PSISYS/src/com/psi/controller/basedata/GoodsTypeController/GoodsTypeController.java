package com.psi.controller.basedata.GoodsTypeController;
...
public class GoodsTypeController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("system/goodstype/goodstype_list");
	...
	public ModelAndView listAllDict(Model model,String DICTIONARIES_ID)throws Exception{
		...
		try{
			...
			mv.addObject("pd", pd);	
			mv.setViewName("system/goodstype/goodstype_ztree");
		} catch(Exception e){
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("system/goodstype/goodstype_edit");
